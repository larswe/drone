...
public class App {
    ...
    public static void main(String[] args) {
        ...
        var sensorStubs = loadSensorStubsForDateFromServer(day, month, year, port);

        var sensors = processSensorStubs(sensorStubs, port);
        ...
        try {
            writeFlightPathToFile(shortestTour, mainDrone, day, month, year);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private static void writeFlightPathToFile(List<Sensor> sensors, MainDrone drone, int day, int month, int year)
            throws IOException {
    ...
    private static FeatureCollection generateFeatureCollection(List<Sensor> sensors, MainDrone drone) {
        var positionHistory = drone.getPositionHistory();
    ...
    private static ArrayList<JsonSensorStub> loadSensorStubsForDateFromServer(int day, int month, int year, int port) {
    ...
    private static ArrayList<Sensor> processSensorStubs(List<JsonSensorStub> sensorStubs, int port) {
