...
public class HeatmapGenerator {
    ...
    /*
     * Input: Name of a file containing 10 lines, where each line consists of 10
    ...
    private static List<Point> genRectCoordinates(double upperLeftLong, double upperLeftLat, double width,
            double height) {
